...
=======
              (.stl) into geant4 compatible format (.gdml)
>>>>>>> 4c12b0f73a2a895cbb9d33574c4ebf0d4b6f6594
>>>>>>> 0477cac45c30143c88bd6efba862f57a0116e11e
"""
...
MATERIALS = '''
	...
	<define>
	    <matrix coldim="2" name="RINDEX0x556962eb9d80" values="1.774e-06 1.58 2.855e-06 1.58 3.105e-06 1.58"/>
    	<matrix coldim="2" name="GROUPVEL0x556962ece160" values="1.774e-06 189.742 2.3145e-06 189.742 3.105e-06 189.742"/>
    	<matrix coldim="2" name="ABSLENGTH0x556962eedd40" values="1.774e-06 4000 2.855e-06 4000 3.105e-06 4000"/>
    	<matrix coldim="2" name="FASTCOMPONENT0x556962ec5260" values="1.774e-06 1 2.855e-06 1 3.105e-06 1"/>
    	<matrix coldim="2" name="SCINTILLATIONYIELD" values="1.774e-06 9200 2.855e-06 9200 3.105e-06 9200"/>
    	<matrix coldim="2" name="RESOLUTIONSCALE" values="1.774e-06 1 2.855e-06 1 3.105e-06 1"/>
    	<matrix coldim="2" name="FASTTIMECONSTANT" values="1.774e-06 3.3 2.855e-06 3.3 3.105e-06 3.3"/>
    	<matrix coldim="2" name="YIELDRATIO" values="1.774e-06 1.0 2.855e-06 1.0 3.105e-06 1.0"/>
    	<matrix coldim="2" name="RINDEX0x556962eb4880" values="1.774e-06 1.6 2.855e-06 1.6 3.105e-06 1.6"/>
    	<matrix coldim="2" name="GROUPVEL0x556962ec7940" values="1.774e-06 187.37 2.3145e-06 187.37 3.105e-06 187.37"/>
    	<matrix coldim="2" name="ABSLENGTH0x556962eaf370" values="1.774e-06 4000 2.855e-06 4000 3.105e-06 4000"/>
		<matrix coldim="2" name="REFLECT_VK" values="1.774e-06 .98 2.855e-06 .98 3.105e-06 .98"/>
  	</define>
...
<<<<<<< HEAD
	 ...
	 <material name="Vikuiti" state="solid">
	 	<property name="RINDEX" ref="RINDEX0x556962eb4880"/>
		<property name="REFLECTIVITY" ref="REFLECT_VK"/>
      	<property name="GROUPVEL" ref="GROUPVEL0x556962ec7940"/>
      	<property name="ABSLENGTH" ref="ABSLENGTH0x556962eaf370"/>
	 ...
	 <!-- EJ208 -->  
	 <!-- EJ-208 -->
	 <material name="EJ208" state="solid">
	 	<property name="RINDEX" ref="RINDEX0x556962eb9d80"/>
      	<property name="GROUPVEL" ref="GROUPVEL0x556962ece160"/>
      	<property name="ABSLENGTH" ref="ABSLENGTH0x556962eedd40"/>
      	<property name="FASTCOMPONENT" ref="FASTCOMPONENT0x556962ec5260"/>
      	...
      	<T unit="K" value="293.15"/>
      	<MEE unit="eV" value="64.6844741120545"/>
		<D unit="g/cm3" value="1.023"/>
		<fraction n="0.4736842105" ref="carbon"/>
		<fraction n="0.5263157895" ref="hydrogen"/>
	 </material>
	</materials>
=======
     <!-- Kapton -->
